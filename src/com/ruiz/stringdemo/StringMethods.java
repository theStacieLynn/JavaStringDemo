...
public class StringMethods {
	...
	public static void demoCharAt() {
		String message = "Welcome to Java";
		System.out.println("The first letter in this message is: "+message.charAt(0));
	}
	public static void demoCompareTo() {
		...
		System.out.println(s1.compareTo(s3));//-1  because "l" is only one time
		System.out.println(s1.compareTo(s4));
		
		/*The above program shows the comparison between the various Strings.
		Notice:
